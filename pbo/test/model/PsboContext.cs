...
namespace test.model
{
    public partial class PsboContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlite(@"data source=""C:\Users\user\Documents\Visual Studio 2015\Projects\PSBO-Sayang\pbo\psbo.db""");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DetailTransaksi>(entity =>
            {
                entity.HasKey(e => e.IdTransaksi)
                    .HasName("sqlite_autoindex_detail_transaksi_1");
            });
        }
    }
}